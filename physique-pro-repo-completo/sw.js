const CACHE='physique-pro-v2-20260919-5';
const CORE=['/','/index.html','/app.css?v=20260919-5','/app.js?v=20260919-5','/manifest.webmanifest','/icon.svg','/icon-192.png','/icon-512.png'];
